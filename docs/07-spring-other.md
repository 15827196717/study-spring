...
![笔记图片 26：64.Spring事件监听的核心机制是什么？](../assets/images/note-026.png)

![笔记图片 27：64.Spring事件监听的核心机制是什么？](../assets/images/note-027.png)

Spring事件机制是观察者模式的一种实现，但是除了发布者和监听者者两个角色之外，还有一个EventMultiCaster的角色负责把事件转发给监听者，工作流程如下：

![笔记图片 28：64.Spring事件监听的核心机制是什么？](../assets/images/note-028.png)
...
![笔记图片 29：65.Spring 框架中都用到了哪些设计模式？](../assets/images/note-029.png)
...
![笔记图片 30：66.Spring是如何整合MyBatis将Mapper接口注册为Bean的原理？](../assets/images/note-030.png)
